...
in {
    ...
    settings = {
      ...
      input = {
        keyboard = {
          ...
          numlock = true; # 在 Nix module 中通常这样写，或者 numlock = {}
        };
      ...
      spawn-at-startup = [
        ...
        {command = ["swaybg" "-i" "/home/hank/wallpapers/nixos-stroke-4k.png" "-m" "fill"];}
        # To run a shell command (with variables, pipes, etc.), use spawn-sh-at-startup:
        # { command = [ "qs" "-c" "~/source/qs/MyAwesomeShell" ]; }
        # (Note: In Nix settings, spawn-sh-at-startup usually maps to `command` as well if using a helper,
        # but technically it is a separate KDL node. Assuming standard module list wrapping)
      ];
      ...
      binds = {
        ...
        "Mod+N".action.focus-column-first = {};
        "Mod+M".action.focus-column-last = {};
        "Mod+Shift+N".action.move-column-to-first = {};
        "Mod+Shift+M".action.move-column-to-last = {};
  ...
  # spawn-at-startup "swaybg" "-i" "/home/hank/wallpapers/nixos-stroke-4k.png" "-m" "fill"
  #
  # // To run a shell command (with variables, pipes, etc.), use spawn-sh-at-startup:
  ...
  #     Mod+A hotkey-overlay-title="Run an Application: walker" { spawn "walker"; }
